...
describe("Behaviour serialisation",() => {
    ...
    it("Passing array via constructor",(done) => {
        class testApp extends spider.Application { }

        class actorClass extends spider.Actor {
            constructor(array) {
                super();
                this.array = array;
                console.log(array);
        ...
        var actor1 = app.spawnActor(actorClass, [["hello", "world"]], 8080);
        actor1.getArray().then((v) => {
            try{
                expect(v[0]).to.equal("hello");
                expect(v[1]).to.equal("world");
                app.kill();
                done()
            }
            catch(e){
