...
BenchConfig.nQueensSolutions = 400;
BenchConfig.nQueensPriorities = 10;
exports.BenchConfig = BenchConfig;
var Benchmark = require('benchmark');
window.Benchmark = Benchmark;
class SpiderBenchmarkOptions {
    constructor(runner, spiderBench) {
        this.defer = true;
        this.async = true;
    ...
    onComplete() {
        ...
        console.log(this.spiderBench.completeMessage + this.stats.mean);
